 ...
 * @author Chanda
 */
public class TravelAdvisorViewCustomerDetails extends javax.swing.JFrame {

    /**
     * Creates new form TravelAdvisorViewCustomerDetails
     */
    public TravelAdvisorViewCustomerDetails() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TravelAdvisorViewCustomerDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TravelAdvisorViewCustomerDetails().setVisible(true);
            }
        });
    }
